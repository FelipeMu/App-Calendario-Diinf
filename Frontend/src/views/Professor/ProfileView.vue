          ...
          <div class="col-lg-4">
            <div class="card mb-4" style="width: 30rem; left:2%;">
              <div class="card-body text-center">
                ...
                <h5 class="my-3">{{profesor.nombre}}</h5>
                <p class="text-muted mb-1">Profesor(a)</p>
                  ...
                  <template>
                    <v-row justify="center">
                      ...
                      >
                        ...
                        <!--VENTANA MODEL & ACTUALIZACIÓN DE DATOS PERSONALES-->
                          ...
                          <v-card-text>
                            <v-container>
                              <v-row>
                                <v-col cols="12">
                                  <v-text-field
                                    label="Nombre y dos apellidos del profesor(a)"
                                    v-model="nombre_profesor"
                                    type="text"
                                    required
                                  ></v-text-field>
                                </v-col>
            ...
            <div class="card mb-4" style="width: 60rem;">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <p class="text-muted mb-0">{{profesor.nombre}}</p>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <p class="text-muted mb-0">{{profesor.correo}}</p>
                  </div>
                </div>
                <hr>
              </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      */
      validarCorreo(){   
        var emailField = this.correo_profesor;
      ...
      */
      validarNombreDeUsuario(){   
        var namefield = this.nombre_profesor;     
      ...
      async VerificarNuevosDatos(){
        if(this.nombre_profesor !="" && this.correo_profesor!=""){
      ...
      async ActualizarDatos(){
        ...
        if(exito == 200){
          ...
          let payload = {
            ...
            correo: this.correo_profesor,
            id_profesor: this.id_profesor
          }
          let ok = 200;
          await axios
            .put("/update/profesor/", payload)
            .then((result) => {
    ...
    async mounted() {
        ...
        await axios
          .get("/perfilprofesor/" + this.id_profesor)
          .then((result) => {
            this.profesor = result.data; 
            this.nombre_profesor = this.profesor.nombre;
            this.correo_profesor = this.profesor.correo;
          }).catch(e => {
                console.log(e);
            }); 
    }  
